...
define(function(require, exports, module){
   Flowplayer vvodplayer () | flowplayer.org/license
...
flowplayer(function(player, root) {
   ...
   player.embedCode = function() {
     ...
     var script = "var w=window,d=document,e;w._fpes||(w._fpes=[],w.addEventListener(\"load\",function(){var s=d.createElement(\"script\");s.src=\"//edu.baiqu.tv/vodplayer/embed.min.js\",d.body.appendChild(s)})),e=[].slice.call(d.getElementsByTagName(\"script\"),-1)[0].parentNode,w._fpes.push({e:e,l:\"$library\",c:$conf});\n".replace('$conf', JSON.stringify(c)).replace('$library', embedConf.library || '');
...
extend(flowplayer, {
   ...
   defaults: {
      ...
      swf: "//edu.baiqu.tv/vodplayer/flowplayer.swf",
      swfHls: "//edu.baiqu.tv/vodplayer/flowplayerhls.swf",
